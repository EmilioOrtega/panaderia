 ...
 * @author Emilio
 */
@ManagedBean (name = "panGelatina")
@RequestScoped
public class panGelatina {
    public int id_pan;
    ...
    public panGelatina(String nombre, String precio, String cantidad, String caducidad, int id_departamento) {
        this.nombre = nombre;
        this.precio = precio;

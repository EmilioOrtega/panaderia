 ...
 * @author Emilio
 */
@ManagedBean (name = "panSalado")
@RequestScoped
public class panSalado {
    public int id_pan;
    ...
    public panSalado(String nombre, String precio, String cantidad, String caducidad, int id_departamento) {
        this.nombre = nombre;
        this.precio = precio;
